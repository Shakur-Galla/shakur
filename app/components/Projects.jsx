...
const projects = [
  ...
  },
  {
    ...
    description:
      "A fullstack SaaS, built with Next.js, Stripe, and MongoDB. Features include User Authentication, Stripe Subscription, AI Integration, Role Based Access, Email Notification.",
    image: Temidun,
    icon: <ShoppingCart className="w-5 h-5" />,
    link: "https:temidun.com",
    tech: ["Next.js", "TypeScript", "Stripe", "MongoDB", "Tailwind CSS"],
    features: [
      "Cron Jobs with automatic Email updates",
      "User authentication and authorization",
      "In-app Video and Audio Recording",
      "Live location reading",
      "Admin Portal and User Dashboards",
      "Mobile App",
    ],
    status: "Completed",
  },
  {
    ...
    description:
      "Free to use Python Editor for learnes, no Signup or Registration. Just open and Code.",
    image: Python,
